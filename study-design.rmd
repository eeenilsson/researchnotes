...
See [An introduction to different types of study design](https://s4be.cochrane.org/blog/2021/04/06/an-introduction-to-different-types-of-study-design/)
...
It can be useful to cite papers that validate the classifications you are using (eg if you use diagnostic codes [@Ludvigsson2011;@Schaufelberger2019;@Rizzuto2018;@Appelros2011;@Ruck2015]).
