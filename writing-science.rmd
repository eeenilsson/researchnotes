...
> Describe the results in words and make references to tables and figures. Point out interesting results, especially those you bring up in the discussion section. Make connections and summarise patterns. All tables and figures should be referenced from the text (**Table 1**).
