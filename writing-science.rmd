...
All tables and figures should be referenced from the text (**Table \@ref(tab:table-one-example)**).
...
When preparing tables, use a clean table layout without colors or shading.
